...
const EditEmplyee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     // alert(formData);
      const response = await fetch(`${API_URL}/vendor/Registrations/${row_id}`, {
        method: 'put',
        headers: {
  ...
  const getDepartments = async () => {
   ...
   const getEmployee = async () => {
    try {
      const deptRes = await fetch(`${API_URL}/vendor/Single-user/${row_id}`);
      const datas = await deptRes.json();
    ...
    setFormData({
      ...
      designation_id: data.designation_id?._id || data.designation_id
    });
  ...
  const getDesignation = async () => {
    try {
      const deptEMP = await fetch(`${API_URL}/vendor/Desg`);
      const datass = await deptEMP.json();
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-3">
                       ...
                       <div className="col-3">
                        <div className="mb-3">
                          <label htmlFor="email" className="form-label">Joining Date</label>
                          <input
                            type="date"
                            className="form-control"
                            id="joining_date"
                    ...
                    <div className="col-3">
                      ...
                      <div className="col-3">
                        <div className="mb-3">
                          <label htmlFor="mobile_no" className="form-label">User Code</label>
                          <input
                            type="text"
                            className="form-control"
                            id="code"
                    ...
                    <div className="row">
                     <div className="col-4">
                      ...
                      <div className="col-4">
                        <div className="mb-3">
                          <label htmlFor="status" className="form-label">Destination Access</label>
                          <select className="form-select" name="destination_type" value={formData.destination_type} onChange={handleInputChange}>
                     ...
                     <div className="col-3">
                        <div className="mb-3">
                          <label htmlFor="email" className="form-label">Employee Salary Per Year</label>
                          <input
                            type="number"
                            className="form-control"
                            id="salary"
                      ...
                      <div className="col-3">
                        <div className="mb-3">
                          <label htmlFor="email" className="form-label">No of Leave</label>
                          <input
                            type="number"
                            className="form-control"
                            id="leave"
                      ...
                      <div className="col-3">
                        <div className="mb-3">
                          <label htmlFor="email" className="form-label">In House No</label>
                          <input
                            type="text"
                            className="form-control"
                            id="in_house_no"
                            name="in_house_no"
                            value={formData.in_house_no}
                            onChange={handleInputChange}
