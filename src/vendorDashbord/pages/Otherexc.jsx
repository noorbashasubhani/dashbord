...
const Otherexc = () => {
  ...
  useEffect(() => {
    const fetchInflows = async () => {
      try {
        const res = await fetch(`${API_URL}/vendor/Other-expences`);
            ...
            <div className="modal-content">
              <form onSubmit={handleSubmit}>
                <div className="modal-header">
                  <h5 className="modal-title">Add Other Expences</h5>
                  <button
                    type="button"
                    className="btn-close"
                ...
                <div className="modal-body">
                  <div className="mb-3">
                    <label className="form-label">Other Expences Name</label>
                    <input
                      type="text"
