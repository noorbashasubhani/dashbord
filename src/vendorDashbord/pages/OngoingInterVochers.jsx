            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-body">
                  <h6 className="card-title" style={{ fontSize: '14px' }}>On Going International Vocher</h6>
                        ...
                        <tbody>
                          {leads
                            .filter((lead) => {
                              ...
                              return start >= today  && lead.holiday_type === 'International';
                            })
                            .map((lead, index) => (
                              <tr key={lead._id}>
                                <td>{index + 1}</td>
...
export default OngoingInterVochers;
