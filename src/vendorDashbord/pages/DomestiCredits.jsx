...
const DomestiCredits = () => {
  ...
  const handleEdit = (credit) => {
    ...
    setForm({
      ...
      travel_type:credit.travel_type || 'D'
    });
    setShowModal(true);
  };
  ...
  return (
    <div className="table-responsive">
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form>
                  <div className="row">
                    {['city', 'supplierName', 'refNumber'].map((field, idx) => (
      ...
      <table className="table table-bordered table-striped">
        ...
        <tbody>
          {data
  .filter(item => item.travel_type === 'D') // 👈 Filter for Domestic only
  .map((item, i) => {
