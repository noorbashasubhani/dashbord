     ...
     const [leads, setLeads] = useState([]);
      ...
      useEffect(() => {
        const fetchLeads = async () => {
          ...
          setError('');
          try {
            const response = await fetch(`${API_URL}/vendor/Delete-Itenarylist`);
            if (!response.ok) {
                            ...
                            <tbody>
                              {leads.map((itms, index) => (
                                <tr key={index}>
                                  ...
                                  <td>
                                    <button className="btn btn-danger btn-sm" onClick={()=>(delFun(itms._id, itms.delete_from))}>Re Store</button>
                                  </td>
                                  <td></td>
